...
export const mockConversations: Conversation[] = [
	{
		...
		lastMessage: 'Thanks for the tip! New workout video dropping tonight 🔥',
	...
	},
	{
		...
		lastMessage: 'That beat is insane! 🎵',
...
export const mockMessages: Record<string, Message[]> = {
	'conv-1': [
		...
		},
		{
			...
			content: 'Aww thank you so much! It means a lot! 💕 Are you enjoying the program so far?',
			isPaid: false,
			isUnlocked: true,
		...
		},
		{
			...
			senderName: 'Luna Rose',
			senderAvatar: 'https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop',
			content: '🔒 Exclusive content for you — my personal workout split that I\'ve never shared publicly!',
			isPaid: true,
			price: 5.00,
			isUnlocked: false,
		...
		},
		{
			...
			senderName: 'Luna Rose',
			senderAvatar: 'https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop',
			content: 'Thanks for the tip! New workout video dropping tonight 🔥',
			isPaid: false,
			isUnlocked: true,
	...
	'conv-3': [
		{
			...
			content: 'Hey! Dropping a new exclusive beat pack for subscribers this weekend. Stay tuned! 🎵',
			isPaid: false,
			isUnlocked: true,
